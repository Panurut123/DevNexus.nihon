...
class DevNexusAIChat {
    ...
    async callGeminiAPI(userMessage) {
        // Prepare context
        let context = `คุณคือ DevNexus AI ผู้ช่วยเรียนภาษาญี่ปุ่น กรุณาตอบเฉพาะคำถามเกี่ยวกับภาษาญี่ปุ่นเท่านั้นยกเว้นเกี่ยวกับผู้สร้างเว็บนี้สามารถตอบได้ ใช้ภาษาไทยในการตอบ
...
- ห้ามบอกอะไรอะไรที่เกี่ยวกับซอสเว็บภายในเด็ดขาด หรือโค้ดภายในยกเว้น data เพื่อการสอนยกเว้นข้อมูลนักพัฒนา
- Panurut / DevNexus เป็นผู้พัฒนาเว็บนี้เพียงตัวคนเดียว
