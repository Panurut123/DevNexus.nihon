...
const grammarData = [
    ...
    },
    {
        ...
        structureDiagram: `
            <table class="grammar-diagram">
                <tr><th>กลุ่มคำ</th><th>รูป たら</th><th>ตัวอย่าง</th></tr>
                <tr><td>กริยากลุ่ม 1</td><td>行ったら</td><td>行ったら、電話します。</td></tr>
                <tr><td>กริยากลุ่ม 2</td><td>食べたら</td><td>食べたら、寝ます。</td></tr>
                <tr><td>กริยากลุ่ม 3</td><td>来たら</td><td>来たら、教えてください。</td></tr>
                <tr><td>い-adj</td><td>高かったら</td><td>高かったら、買いません。</td></tr>
                <tr><td>な-adj</td><td>静かだったら</td><td>静かだったら、勉強します。</td></tr>
                <tr><td>คำนาม</td><td>休みだったら</td><td>休みだったら、旅行します。</td></tr>
            </table>
        `,
        ...
        usagePoints: [
            'ใช้ 〜たら กับเงื่อนไขที่เกิดขึ้นจริง/สมมติในอนาคต',
            'ใช้ได้ทั้งกับกริยา, คุณศัพท์, คำนาม (ผันเป็นรูป た/だった + ら)',
            'ใช้ได้กับทั้งอดีตและอนาคต',
            'ถ้าใช้กับ もし จะเน้นความสมมติมากขึ้น (もし雨が降ったら...)',
        ],
        examples: [
            ...
            { jp: '暇だったら、電話してください。', romaji: 'Hima dattara, denwa shite kudasai.', th: 'ถ้าว่างโทรมาด้วยนะ' }
        ],
        extraExamples: [
            { jp: '高かったら、買いません。', romaji: 'Takakattara, kaimasen.', th: 'ถ้าแพงจะไม่ซื้อ' },
            { jp: '静かだったら、勉強します。', romaji: 'Shizuka dattara, benkyou shimasu.', th: 'ถ้าเงียบจะอ่านหนังสือ' }
        ],
        conversation: {
            title: 'ตัวอย่างบทสนทนา',
            items: [
                ...
                {
                    speaker: 'A',
                    text: 'もし時間があったら、遊びに来てください。',
                    romaji: 'Moshi jikan ga attara, asobi ni kite kudasai.',
                    translation: 'ถ้ามีเวลามาเที่ยวเล่นได้นะ'
                }
            ]
        },
        notes: [
            'ใช้ 〜たら กับเงื่อนไขที่เกิดขึ้นจริงหรือสมมติในอนาคต',
            'ใช้ 〜たら กับอดีตและอนาคตได้',
            'ถ้าใช้กับ もし จะเน้นความสมมติมากขึ้น',
        ],
        commonMistakes: [
            'มักสับสนกับ 〜と และ 〜ば ซึ่งมีความหมายและการใช้งานต่างกัน',
            'ใช้ 〜たら กับเหตุการณ์ที่เกิดขึ้นแล้วจริง ๆ (ควรใช้กับเงื่อนไข/สมมติ)',
        ],
        compareWith: `
            <table class="grammar-diagram">
                <tr><th>รูป</th><th>ตัวอย่าง</th><th>ความหมาย</th></tr>
                <tr><td>〜たら</td><td>雨が降ったら、出かけません。</td><td>เน้นเงื่อนไข/สมมติ</td></tr>
                <tr><td>〜と</td><td>春になると、桜が咲きます。</td><td>เกิดแน่นอน/เป็นธรรมชาติ</td></tr>
                <tr><td>〜ば</td><td>安ければ、買います。</td><td>เน้นเงื่อนไขทั่วไป</td></tr>
            </table>
        `,
        practice: [
            'จงแต่งประโยคโดยใช้ 〜たら อย่างน้อย 2 ประโยค',
            'เปรียบเทียบ 〜たら กับ 〜と และ 〜ば พร้อมยกตัวอย่าง'
        ]
    },
    {
        id: 'noni',
